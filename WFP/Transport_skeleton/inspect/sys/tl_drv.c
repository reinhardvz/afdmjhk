...
Abstract:
   ...
   HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Inspect
    ...
    o  RemoteAddressToIntercept (REG_SZ) : literal IPv4/IPv6 string 
                                                (e.g. “10.0.0.1”)
   ...
   )
{
   ...
   filter.action.type = FWP_ACTION_CALLOUT_TERMINATING;//FWP_ACTION_CALLOUT_UNKNOWN;//FWP_ACTION_CALLOUT_TERMINATING;
   ...
   //conditionIndex = 0;
	filter.filterCondition = NULL ;	//filterConditions;
	filter.numFilterConditions = 0 ; //1;
